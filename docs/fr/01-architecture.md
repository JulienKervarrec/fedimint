# 1. Architecture — Fedimint

Ce dépôt rassemble les composants de référence consacrés à les fédérations chaumiennes, les modules et la conservation communautaire de bitcoins.
...
[Chapitre suivant : Consensus fédéré et modules](02-consensus-federe-et-modules.md)
